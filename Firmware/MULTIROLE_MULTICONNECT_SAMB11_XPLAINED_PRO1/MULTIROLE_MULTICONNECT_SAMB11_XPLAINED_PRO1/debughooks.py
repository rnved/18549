...
def HandlePatchBreakpoint(api):
	...
	api.Write32(0x100401c0,0x10006ab3)	# spi_slave_eif_init (Function)
	api.Write32(0x1004000c,0x10005511)	# rw_main (Function)
	api.Write32(0x10040010,0x10005609)	# rwip_eif_get (Function)
	api.Write32(0x1004004c,0x10005685)	# XTAL_mode_check (Function)
	api.Write32(0x10040034,0x10005753)	# system_sleep (Function)
	api.Write32(0x10040068,0x10005b15)	# rwble_isr (Function)
	api.Write32(0x10040088,0x10005c1d)	# lld_evt_schedule (Function)
	api.Write32(0x100400bc,0x10005d3d)	# gapm_get_task_from_id (Function)
	api.Write32(0x100400e4,0x10005e7d)	# ke_msg_send (Function)
	api.Write32(0x100400e8,0x100060e1)	# rf_init (Function)
	api.Write32(0x100400ec,0x10006195)	# ulp_rf_init (Function)
	api.Write32(0x1004010c,0x10006345)	# rwip_sleep (Function)
	api.Write32(0x10040154,0x1000654d)	# intc_init (Function)
	api.Write32(0x10040160,0x100065fd)	# uart_init (Function)
	api.Write32(0x10040174,0x10006779)	# ulp_wakeup (Function)
	api.Write32(0x10040210,0x100075c1)	# clkClb_informAction (Function)
	api.Write32(0x10040038,0x10005919)	# early_entry (Function)
	api.Write32(0x1000003C,0x100058f5)	# 0x1000003C (Address)
	api.Write32(0x10007bf4,0x00000001)	# gu32_override_xo_cap_values (Variable)
	api.Write32(0x10007bf8,0x00000004)	# gu32xo_cap_values (Variable)
